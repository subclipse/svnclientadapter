...
public class DeleteTest extends SVNTest {
	...
	public void testBasicDelete() throws Throwable
	{
	    ...
	    thisTest.getWc().setItemTextStatus("A/B/X", SVNStatusKind.ADDED);
	    ...
	    thisTest.getWc().setItemTextStatus("A/B/X/xi", SVNStatusKind.ADDED);
	
	    // create & add the directory A/B/Y
	    file = new File(thisTest.getWCPath(), "A/B/Y");
	    client.mkdir(file);
	    thisTest.getWc().addItem("A/B/Y", null);
	    thisTest.getWc().setItemTextStatus("A/B/Y", SVNStatusKind.ADDED);
	    ...
	    thisTest.getWc().setItemTextStatus("A/B/E/alpha",SVNStatusKind.DELETED);
	    thisTest.getWc().setItemTextStatus("A/B/E/beta",SVNStatusKind.DELETED);
	    ...
	    thisTest.getWc().setItemPropStatus("A/D/G/rho", SVNStatusKind.NORMAL);
	    ...
	    thisTest.getWc().setItemTextStatus("A/B/F",SVNStatusKind.DELETED);
	    thisTest.getWc().setItemPropStatus("A/B/F", SVNStatusKind.NORMAL);
	    client.remove(new File[] { new File(thisTest.getWCPath()+"/A/C")}, true);
	    thisTest.getWc().setItemTextStatus("A/C",SVNStatusKind.DELETED);
	    ...
	    thisTest.getWc().setItemTextStatus("iota",SVNStatusKind.DELETED);
